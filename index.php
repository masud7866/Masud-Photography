          ...
          foreach ($get_all_photos as $row) {
              ...
              <div class="col-sm-6 col-md-3 col-lg-3 <?php echo "album".$row[7]." photographer".$row[6]?>">
                  <div class="portfolio-item">
                      <div class="hover-bg"><a href="img/portfolio/<?php echo $row[8]?>" title="<?php if($row[4]=="0000-00-00"){$row[4]="Unknown";} if($row[5]==""){$row[5]="Unknown";} echo "Date of Capture: ".$row[4].", Location: ".$row[5].", Genre: ";foreach (getAlbumGenreByID($row['7']) as $row2){echo $row2[0];};?>"
            ...
            <div class="row" >
                ...
                <div class="col-md-6 social">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="col-md-4">
                                <a style="width:69.438px" class="btn btn-default" href="https://fb.com/masud7866"><i class="fa fa-facebook"></i></a>
                            </div>

                            <div class="col-md-4">
                                <a  class="btn btn-default"  href="https://twitter.com/masud7866/"><i class="fa fa-twitter"></i></a>
                            </div>

                            <div class="col-md-4">
                                <a class="btn btn-default"  href="https://instagram.com/masud7866/"><i class="fa fa-instagram"></i></a>
                            </div>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="col-md-4">
                                <a class="btn btn-default"  href="https://linkedin.com/in/masud7866/"><i class="fa fa-linkedin"></i></a>
                            </div>
                            <div class="col-md-4">
                                <a class="btn btn-default"  href="https://github.com/masud7866/"><i class="fa fa-github"></i></a>
                            </div>

                            <div class="col-md-4">
                                <a class="btn btn-default"  href="https://plus.google.com/u/0/+MasudRahman7866/"><i class="fa fa-google-plus"></i></a>
                            </div>
                        </div>
